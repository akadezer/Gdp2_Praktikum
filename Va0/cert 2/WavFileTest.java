...
public class WavFileTest {
	...
	public void testSuperClass() {
		assertEquals("WavFile ist not derived from SampledFile", "SampledFile", clazz.getSuperclass().getName());
	}
	...
	public void test_computeDuration_01() {
		assertEquals("Wrong time format", 100000000L, WavFile.computeDuration(1000L, 10.0f));
		assertEquals("Wrong time format", 2000000L, WavFile.computeDuration(88200L, 44100.0f));
		assertEquals("Wrong time format", 141400816L, WavFile.computeDuration(6235776L, 44100.0f));
	}
