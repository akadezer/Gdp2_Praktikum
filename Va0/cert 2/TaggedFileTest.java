...
public class TaggedFileTest {
	...
	public void testSuperClass() {
		assertEquals("TaggedFile ist not derived from SampledFile", "SampledFile", clazz.getSuperclass().getName());
	}
	...
	public void testToString() {
		assertEquals("toString not correct", "Eisbach - Rock 812 - The Sea, the Sky - 05:31", f1.toString());
		assertEquals("toString not correct",
				"Wellenmeister - TANOM Part I: Awakening - TheAbsoluteNecessityOfMeaning - 05:55", f2.toString());
		assertEquals("toString not correct", "beethoven-ohne-album - 00:06", f3.toString());
	}
	...
	public void test_readAndStoreTags_01() {
		...
		assertEquals("Wrong album", "TheAbsoluteNecessityOfMeaning", f2.getAlbum());
	...
	public void testNrAttributes() {
		assertTrue("Do not define any local variables of methods as attributes?",
